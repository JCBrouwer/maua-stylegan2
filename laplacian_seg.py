...
plt.savefig("workspace/lapspec.pdf")
...
plt.savefig("workspace/lapcqt.pdf")
...
librosa.display.specshow(
    Rf, cmap="inferno_r", y_axis="time", x_axis="s", y_coords=beat_times, x_coords=beat_times, ax=ax[0]
)
ax[0].set(title="Recurrence similarity")
ax[0].label_outer()
librosa.display.specshow(
    R_path, cmap="inferno_r", y_axis="time", x_axis="s", y_coords=beat_times, x_coords=beat_times, ax=ax[1]
)
ax[1].set(title="Path similarity")
ax[1].label_outer()
librosa.display.specshow(
    A, cmap="inferno_r", y_axis="time", x_axis="s", y_coords=beat_times, x_coords=beat_times, ax=ax[2]
)
ax[2].set(title="Combined graph")
ax[2].label_outer()
plt.savefig("workspace/laprecurrence.pdf")
...
librosa.display.specshow(
    Rf, cmap="inferno_r", y_axis="time", x_axis="time", y_coords=beat_times, x_coords=beat_times, ax=ax[1]
)
...
plt.savefig("workspace/lapstruct.pdf")
...
plt.savefig("workspace/lapclust.pdf")
...
for interval, label in zip(zip(bound_times, bound_times[1:]), bound_segs):
    ...
    print(interval[0], label)
plt.savefig("workspace/lapseg.pdf")
